...
local function createPlayerMenu(players)
    ...
    playerDropdownFrame.BackgroundColor3 = Color3.fromRGB(100, 100, 100) -- Ändere die Hintergrundfarbe
    playerDropdownFrame.BorderSizePixel = 2
    playerDropdownFrame.BorderColor3 = Color3.fromRGB(50, 50, 50) -- Ändere die Randfarbe
    ...
    dropdownLabel.TextColor3 = Color3.fromRGB(255, 255, 255) -- Ändere die Textfarbe
    ...
    dropdown.BackgroundColor3 = Color3.fromRGB(50, 50, 50) -- Ändere die Hintergrundfarbe
    dropdown.BorderSizePixel = 0
    dropdown.Text = "Click to select"
    dropdown.TextColor3 = Color3.fromRGB(255, 255, 255) -- Ändere die Textfarbe
    ...
    dropdownList.BackgroundColor3 = Color3.fromRGB(50, 50, 50) -- Ändere die Hintergrundfarbe
    dropdownList.BorderSizePixel = 2
    dropdownList.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Ändere die Randfarbe
    ...
    for _, player in ipairs(players) do
        if player ~= game.Players.LocalPlayer then
            ...
            dropdownItem.BackgroundColor3 = Color3.fromRGB(50, 50, 50) -- Ändere die Hintergrundfarbe
            dropdownItem.BorderSizePixel = 0
            dropdownItem.Text = player.Name
            dropdownItem.TextColor3 = Color3.fromRGB(255, 255, 255) -- Ändere die Textfarbe
